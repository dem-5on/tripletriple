...
logger = logging.getLogger("openclaw.version")
...
def get_project_root() -> Path:
    """Return the root of the openclaw package (where pyproject.toml lives)."""
...
def restart_process():
    ...
    logger.info("Restarting OpenClaw process...")
